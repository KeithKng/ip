...
- After every code or documentation change, suggest a commit message in the repository's preferred style: imperative mood, concise subject line (ideally under 50 characters, hard limit 72), optional scope or category prefix, no trailing period, and a brief body explaining the rationale. Do not commit or push unless the user explicitly asks for it.
